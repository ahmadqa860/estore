...
<div class="row">
    <div class="col-md-6 mb-5">
        <form action="{{ url('cms/products/'.$item['id']) }}" method="POST" novalidate autocomplete="off" enctype="multipart/form-data">
            @csrf
            {{ method_field('PUT') }}
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="categorie_id" id="categorie_id">
                    ...
                    <option @if($item['categorie_id'] == $category['id']) selected @endif value="{{ $category['id'] }}">{{ $category['ctitle'] }}</option>
                    @endforeach
                </select>
